...
import {
  ...
  Globe, ArrowRight, Star, CheckCircle,
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-xs text-gray-400 max-w-xs mb-3">{t.footer.desc}</p>
              <div className="flex gap-2">
                <a href="https://whatsapp.com/channel/0029Vark1I1AYlUR1G8YMX31" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 bg-white/5 hover:bg-green-500/20 border border-white/10 hover:border-green-500/30 rounded-lg flex items-center justify-center transition-colors group"
                  title="WhatsApp Channel">
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-green-400" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://t.me/xhrishost" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/30 rounded-lg flex items-center justify-center transition-colors group"
                  title="Telegram">
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://xhrisfolio.vercel.app" target="_blank" rel="noopener noreferrer"
                  className="w-8 h-8 bg-white/5 hover:bg-purple-500/20 border border-white/10 hover:border-purple-500/30 rounded-lg flex items-center justify-center transition-colors group"
                  title="Portfolio">
            ...
            <div>
              <h4 className="text-xs font-semibold text-white mb-3">{t.footer.product}</h4>
              <ul className="space-y-2">
                {['Dashboard', 'Bots', lang === 'fr' ? 'Serveurs' : 'Servers', 'Marketplace'].map((link) => (
                  <li key={link}>
            ...
            <div>
              <h4 className="text-xs font-semibold text-white mb-3">{t.footer.community}</h4>
              <ul className="space-y-2">
                <li>
                  <a href="https://whatsapp.com/channel/0029Vark1I1AYlUR1G8YMX31" target="_blank" rel="noopener noreferrer"
                ...
                <li>
                  <a href="https://t.me/xhrishost" target="_blank" rel="noopener noreferrer"
                    className="text-xs text-gray-400 hover:text-white transition-colors">Telegram</a>
                </li>
              </ul>
            </div>

            <div>
              <h4 className="text-xs font-semibold text-white mb-3">{t.footer.developer}</h4>
              <ul className="space-y-2">
                <li>
                  <a href="https://xhrisfolio.vercel.app" target="_blank" rel="noopener noreferrer"
                    className="text-xs text-gray-400 hover:text-purple-400 transition-colors">{t.footer.portfolio}</a>
                </li>
                <li>
                  <a href="#" className="text-xs text-gray-400 hover:text-white transition-colors">
                    {lang === 'fr' ? 'Documentation' : 'Docs'}
                  </a>
                </li>
              </ul>
            </div>
