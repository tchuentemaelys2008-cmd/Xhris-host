...
export const authOptions: NextAuthOptions = {
  providers: [
    ...
    GoogleProvider({
      ...
      // NextAuth builds the redirect_uri automatically from NEXTAUTH_URL env var.
      // Make sure NEXTAUTH_URL=https://xhris-host-frontend.vercel.app in Vercel settings.
    }),
  ],
  callbacks: {
